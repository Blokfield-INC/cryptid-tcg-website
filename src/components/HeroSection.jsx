    ...
    >
      <div class="container mx-auto px-6 relative z-10">
        <div class="text-center">
          <div class="mb-6">
            <span class="text-cyan-400 text-lg orbitron">CARD GAME</span>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
            <button class="battle-ready bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 px-10 py-5 rounded-full text-xl font-bold orbitron transition duration-300 shadow-2xl card-glow border border-cyan-400">
              <i class="fas fa-sword mr-3"></i>ENTER BATTLE
            </button>
            <button class="battle-ready bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 px-10 py-5 rounded-full text-xl font-bold orbitron transition duration-300 shadow-2xl card-glow border border-purple-400">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            <div class="gaming-card rounded-lg p-4 text-center">
              <div class="text-cyan-400 text-2xl font-bold orbitron">1M+</div>
            ...
            <div class="gaming-card rounded-lg p-4 text-center">
              <div class="text-pink-400 text-2xl font-bold orbitron">24/7</div>
              <div class="text-gray-400 text-sm">BATTLES</div>
            </div>
            <div class="gaming-card rounded-lg p-4 text-center">
